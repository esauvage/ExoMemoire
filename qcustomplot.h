...
public:
  ...
  */
  ...
  void setData(const QVector<TKeys> &keys, const QVector<double> &values, bool alreadySorted=false)
  {
  ...
  // non-property methods:
  template <class TKey>
  void addData(const QVector<TKey> &keys, const QVector<double> &values, bool alreadySorted=false)
  {
